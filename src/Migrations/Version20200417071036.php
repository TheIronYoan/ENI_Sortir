 ...
 */
final class Version20200417071036 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE events (id INT AUTO_INCREMENT NOT NULL, organizer_id INT NOT NULL, campus_id INT DEFAULT NULL, name VARCHAR(50) NOT NULL, start DATETIME NOT NULL, duration INT NOT NULL, sign_in_limit DATETIME NOT NULL, max_users INT NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_5387574A876C4DDA (organizer_id), INDEX IDX_5387574AAF5D55E1 (campus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, firstname VARCHAR(50) NOT NULL, username VARCHAR(2) NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(10) DEFAULT NULL, email VARCHAR(75) NOT NULL, administrator TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
